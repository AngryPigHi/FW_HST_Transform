...
{
    public partial class DbmsTabcompTempUncmp
    {
        public string B { get; set; }
        public string Bdcdyh { get; set; }
        public string Bdczt { get; set; }
        public string Bgbh { get; set; }
        public string Bz { get; set; }
        public string Cb { get; set; }
        public decimal? Cg { get; set; }
        public int? Ch { get; set; }
        public string Chyt { get; set; }
        ...
        public decimal? Sbjgm { get; set; }
        public decimal? Sbjgt { get; set; }
        ...
        public string FwHsIndex1 { get; set; }
        public string FwDcbIndex1 { get; set; }
        public string Bdcdyh2 { get; set; }
        public string Zfbdcdyh { get; set; }
        public string Sjhj { get; set; }
        public string DateHouseCompletion { get; set; }
        public decimal? SzcStart { get; set; }
        public decimal? SzcEnd { get; set; }
        public decimal? Tdmj { get; set; }
        public string Bdcdyhxg { get; set; }
        public string Qyhf { get; set; }
        public byte? Wlcsxg { get; set; }
        public string Dycsxg { get; set; }
        public string Fjhxg { get; set; }
        public string Xgry { get; set; }
        public string Xgbz { get; set; }
        public string Xgzt { get; set; }
        public string Xgrq { get; set; }
        public string FwDcbIndexxg { get; set; }
        public string Zlxg { get; set; }
        public string DjhXlf { get; set; }
    }
}
