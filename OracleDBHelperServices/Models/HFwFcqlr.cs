...
namespace OracleDBHelperServices.Models
{
    public partial class HFwFcqlr
    {
        ...
        public string Fczbh { get; set; }
        public string FwFcqlrIndex { get; set; }
