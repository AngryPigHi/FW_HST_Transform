...
namespace OracleDBHelperServices.Models
{
    public partial class A87
    {
        ...
        public long? Syzxl { get; set; }
        public decimal? Ccgd { get; set; }
        public decimal? Cdfgd { get; set; }
        public string Cdjq { get; set; }
        public string Cdysz { get; set; }
