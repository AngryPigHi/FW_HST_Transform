...
namespace OracleDBHelperServices.Models
{
    public partial class ZdQsdc
    {
        ...
        public string ZdQsdcIndex { get; set; }
        public byte[] Zdct { get; set; }
        public byte[] Zjwts { get; set; }
        public string Zygdwzsm { get; set; }
        public string Zyjxzxsm { get; set; }
    }
}
